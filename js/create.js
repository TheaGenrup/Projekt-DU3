...
async function addBoardOrReview(bodyData) {
    ...
    if (uploadWrapper.dataset.type === "review") {
        ...
        const request = new Request("/ht22/dig_cave/Laulu/server/addBoardOrReview.php", {
            method: "POST",
...
async function renderCreateReview(albumData) {
    ...
    starRatings.forEach(star => {
        ...
        star.addEventListener("mouseover", (e) => {
            ...
            starRatings.forEach(star => {
                star.style.backgroundImage = "url(/ht22/dig_cave/Laulu/media/icons/star-regular.svg)";
            });
            for (let i = 0; i < index; i++) {
                starRatings[i].style.backgroundImage = "url(/ht22/dig_cave/Laulu/media/icons/star-solid.svg)";
        ...
        star.addEventListener("mouseleave", (e) => {
            ...
            starRatings.forEach(star => {
                if (!star.classList.contains("chosen")) {
                    ...
                    starRatings[0].style.backgroundImage = "url(/ht22/dig_cave/Laulu/media/icons/star-solid.svg)";
                }
            });
        });
